...
* [什么是数据库事务？如果没有事物会有什么后果？事务的特性是什么？](#什么是数据库事务？如果没有事物会有什么后果？事务的特性是什么？)
* [什么是脏读？幻读？不可重复读？](#什么是脏读？幻读？不可重复读？)
* [什么是事务的隔离级别？Mysql的默认隔离级别是？](#什么是事务的隔离级别？Mysql的默认隔离级别是？)
* [事物隔离是怎么实现的？](#事物隔离是怎么实现的？)
* [有哪些锁？分别介绍下](#有哪些锁？分别介绍下)
